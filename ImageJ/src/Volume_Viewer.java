...
//	private static String volumePath = "1.zip";
//	private static String volumePath = "ch2.nii";
	private static String volumePath = "globe.tif";
...
//		str = "display_mode=4 axes=0 markers=1 z-aspect=4 sampling=1 lut=0 scale=0.75 dist=-300 angle_x=115 angle_z=41";
